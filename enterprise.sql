...
CREATE TABLE `sys_dept`  (
  `dept_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '部门id',
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '部门名称',
  `parent_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '上级部门id',
  `level` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '部门层级',
  `order_id` int(11) NULL DEFAULT 0 COMMENT '部门在当前层级下的顺序，由小到大',
  `remark` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '备注',
  `operator` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '操作者',
  `operator_time` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '最后一次操作时间',
  `operator_ip` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '最后一名操作者的ip',
  `type` int(3) NOT NULL COMMENT '状态：0删除 1修改 2新增',
  `code` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '部门编号',
...
CREATE TABLE `sys_user`  (
  `user_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '主键',
  `username` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '用户名字',
  `telephone` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '用户手机号',
  `mail` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '用户邮箱',
  `password` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '用户密码',
  `account` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '账号',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '备注',
  `dep_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '用户部门表',
  `status` tinyint(3) NULL DEFAULT 1 COMMENT '用户的状态 1 ：正常  0：冻结 2：删除',
  `operator` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '操作人',
  `operator_time` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '操作时间',
  `operator_ip` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '操作人的ip',
  `is_manager` int(4) NULL DEFAULT NULL COMMENT '账户类型',
  `order_id` int(10) NULL DEFAULT NULL COMMENT '排序',
  `timestamp` bigint(20) NULL DEFAULT NULL COMMENT '时间戳',
...
-- Records of t_about
-- ----------------------------
INSERT INTO `t_about` VALUES (6, '<span style=\"color:#333333;\">1111</span>');
...
-- ----------------------------
INSERT INTO `t_contact` VALUES (5, '<span style=\"white-space:normal;\">公司地址：111</span>\r\n<p style=\"white-space:normal;\">\r\n	电话：1355555555\r\n</p>\r\n<p style=\"white-space:normal;\">\r\n	联系人：111\r\n</p>\r\n<p style=\"white-space:normal;\">\r\n	传真：+86 1111\r\n</p>\r\n<p style=\"white-space:normal;\">\r\n	邮箱：1111\r\n</p>\r\n<p style=\"white-space:normal;\">\r\n	<br />\r\n</p>\r\n<p style=\"white-space:normal;\">\r\n	<br />\r\n</p>\r\n<p style=\"white-space:normal;\">\r\n	<br />\r\n</p>');
...
CREATE TABLE `t_friendlinks`  (
  ...
  `target` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '_blank',
...
CREATE TABLE `t_indeximg`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(245) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `pictureUrl` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `orders` int(11) NOT NULL,
  `link` varchar(145) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `t_indeximg` VALUES (20, '装饰图1', '/attached/image/20200722/20200722104804_36.jpg', 1, '#', 'y');
INSERT INTO `t_indeximg` VALUES (21, '装饰图2', '/attached/image/20200722/20200722104819_166.png', 2, '#', 'y');
INSERT INTO `t_indeximg` VALUES (23, '装饰图3', '/attached/image/20200722/20200722104828_109.png', 3, '#', 'y');
...
CREATE TABLE `t_menu`  (
  ...
  `name` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '111',
...
CREATE TABLE `t_recruitment`  (
  ...
  `nature` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `number` int(11) NULL DEFAULT NULL,
  `education` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `experience` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `requirements` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `createtime` datetime(0) NULL DEFAULT NULL,
  `createAccount` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `status` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_service`  (
  ...
  `contentHtml` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `status` varchar(4) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `t_service` VALUES (1, '技术支持', '公司的最新新闻在此发布', 'y', 2);
INSERT INTO `t_service` VALUES (2, '平台运维', '211231212121212', 'y', 1);
...
CREATE TABLE `t_systemlog`  (
  ...
  `loginArea` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `diffAreaLogin` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'n',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `t_systemlog` VALUES (439, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-17 09:55:23', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (440, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-17 16:52:04', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (441, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-17 17:28:19', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (442, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-17 17:35:23', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (443, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-17 17:51:53', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (444, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-20 10:26:26', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (445, 'loginOut', 'loginOut', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-20 17:18:06', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (446, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-20 17:18:12', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (447, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-20 17:27:18', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (448, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-20 17:30:05', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (449, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-21 09:31:51', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (450, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-21 09:47:47', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (451, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-21 09:56:10', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (452, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-22 10:47:45', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (453, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-22 10:52:33', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (454, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-22 10:55:29', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (455, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-28 17:11:19', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (456, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-29 09:11:31', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (457, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-29 09:39:55', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (458, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-29 09:49:04', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (459, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-29 10:02:58', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (460, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-29 10:28:32', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (461, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-29 11:36:28', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (462, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-29 11:45:14', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (463, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-29 15:36:21', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (464, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-29 15:41:15', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (465, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-29 15:59:56', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (466, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-29 16:24:01', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (467, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-29 16:34:24', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (468, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 09:09:21', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (469, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 10:02:14', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (470, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 10:31:13', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (471, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 10:41:20', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (472, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 10:52:56', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (473, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 10:53:59', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (474, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 11:16:47', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (475, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 11:21:12', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (476, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 13:46:46', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (477, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 13:56:36', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (478, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 13:58:36', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (479, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 14:06:02', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (480, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 14:09:56', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (481, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 14:26:17', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (482, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 14:27:56', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (483, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 14:45:55', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (484, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-30 15:58:36', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (485, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-31 13:54:59', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (486, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-31 14:08:48', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (487, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-31 14:23:14', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (488, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-31 15:01:18', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (489, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-31 15:25:09', NULL, 'n');
INSERT INTO `t_systemlog` VALUES (490, 'login', 'login', 1, 'admin', '0:0:0:0:0:0:0:1', '2020-07-31 15:27:47', NULL, 'n');
...
CREATE TABLE `t_systemsetting`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `systemCode` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `www` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `icp` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `isopen` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'y',
  ...
  `imageRootPath` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `version` varchar(145) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `qqService` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `statisticsCode` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `t_user`  (
  ...
  `createAccount` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `updateAccount` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `nickname` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `email` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `portrait` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
